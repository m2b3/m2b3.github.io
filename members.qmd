...
[![Kevin (Yuze) Liu](images/Kevin.jpg){fig-alt="Photo of Kevin (Yuze) Liu"}](#Kevin)

[![Edward Tong](images/edtong.jpg){fig-alt="Photo of Edward Tong"}](#Edward)

[![Youyou Yang](images/youyou.jpg){fig-alt="Photo of Youyou Yang"}](#Claire)

[![Lihong Chen](images/LC.jpg){fig-alt="Photo of Lihong Chen"}](#Lihong)

[![Linjing Wang](images/linjing.jpg){fig-alt="Photo of Linjing Wang"}](#Linjing)

[![Jonathan Morris](images/DSC_5520.JPG){fig-alt="Photo of Jonathan Morris"}](#Jonathan)

[![Rashed Alhosani](images/marty2.png){fig-alt="Photo of Rashed Alhosani"}](#Rashed)

[![Deepansh Goel](images/9nyvij-min.jpg){fig-alt="Photo of Deepansh Goel"}](#Deepansh)
...
::: column-margin
![](images/Kevin.jpg){fig-alt="Photo of Kevin (Yuze) Liu" width="200"}
:::

-   MSc,BSc - data science, statistics and CS, McGill.

-   I recently graduated from McGill University with a Master's in Information Studies (Data Science) and a Bachelor's in Statistics with a minor in Computer Science. My academic and research experience spans machine learning, NLP, and ethical AI applications. Currently, I am interested in exploring how large language models (LLMs) can be applied to real-world data challenges, especially in multilingual, dynamic, or multimodal environments. My goal is to develop research that bridges theoretical advances in LLMs with practical, high-impact use cases.

-   [Email](mailto:yuze.liu@mail.mcgill.ca)
...
::: column-margin
![](images/edtong.jpg){fig-alt="Photo of Edward Tong" width="200"}
:::
...
::: column-margin
![](images/youyou.jpg){fig-alt="Photo of Youyou Yang" width="200"}
:::
...
::: column-margin
![](images/LC.jpg){fig-alt="Photo of Lihong Chen" width="200"}
:::

-   M.Eng. in Artificial Intelligence, Western University. B.Eng. in Software Engineering, East China Normal University, Shanghai, China.

-   Currently exploring visual attention and how semantic information guides perception and behavior. Previously worked on visual perception and multimodal reasoning in autonomous systems. I am broadly interested in the interaction between visual and language information in task-driven behavior, and in how computational models can help us understand and replicate these processes.

-   [Email](mailto:lchen893@uwo.ca)
...
::: column-margin
![](images/linjing.jpg){fig-alt="Photo of Linjing Wang" width="200"}
:::

-   Bsc. In Mathematics, The University of Hong Kong.

-   My second major is Neuroscience, and I’m interested in computational neuroscience, deep learning, and their relationship. By training models to solve biological tasks, I want to uncover what makes neural systems so robust and efficient.

-   [Email](mailto:linjing.wang@mail.mcgill.ca)
...
::: column-margin
![](images/DSC_5520.JPG){fig-alt="Photo of Jonathan Morris" width="200"}
:::

-   Bsc. in Statistics, Bsc. in Psychology, University of Wisconsin-Madison

-   I'm interested in time series analysis, network analysis, and applications to the study of neuroscience and health.
...
::: column-margin
![](images/marty2.png){fig-alt="Photo of Rashed Alhosani" width="200"}
:::

-   BSc in Computational Systems, Zayed University

-   I'm interested in exploring how computational models can be used to understand biological tasks through rich data.

-   [Email](mailto:rashed.alhosani@mail.mcgill.ca)
...
::: column-margin
![](images/9nyvij-min.jpg){fig-alt="Photo of Deepansh Goel" width="200"}
:::

-   BTech in Computer Science and Engineering, AIML, Maharaja Agrasen Institute of Technology, Delhi, India

-   I'm interested in Computer Vision, AI, Music and Robotics.
...
latlist <- c(8.561259, 30.605053, 32.08233, 43.6532, 53.13333, 43.70313, 48.831704, 30.0444, 41.084148, 37.0, 45.45778, 45.56583, 50.848383801134766, 45.5019, 33.88534, 32.3274, 14.6584, 32.4279, 37.8706, 50.6, 45.25, 48.84674234948124, 31.2304, 41.9001, 31.311206, 60.29335, 45.3, 19.00437473941976, 19.1911, 30.605053, 32.119023, 31.9796, 46.8852, 45.5019, 40.022709, 45.5103643, 39.9042, 45.51, 31.8775, 31.8206, 36.0671, 43.0722, 24.4539, 28.7041)



lonlist <- c(76.874224, 104.074123, 34.881787, -79.3832, 23.16433, 7.26608, 1.609642, 31.2357, 29.03546, 3.0, -73.88489, -73.31437, 4.350009489440508, -73.567, 35.5115, 50.865, 100.3947, 53.688, 112.5486, 3.0, 5.75, 2.3724100000000004, 121.4737, -71.0898, 75.584556, 25.03784, -73.33, 72.85023541069054, 72.856, 104.074123, 34.819675, 120.8937, -56.3159, -73.5674, -75.320869, -73.5746522, -116.4074, -73.58, 120.5511, 117.2272, 120.3826, -89.40123, 54.3773, 77.1025)

namezlist <- c("suresh", "Haoxiang", "oren", "amanda", "kasia", "Anais", "yohai", "Injy", "Yavuz", "Lilia", "Alexandru", "Youzhi", "noa", "Bradley", "Sarah", "Pegah", "Divi", "Romina", "Sizhuo", "Lilie", "jerome", "Louis", "jacky", "alexparent", "Yagya", "lian", "azhao", "dinesh", "dhruvanshu", "buxin", "maya", "evan", "isidore", "sabrina", "annarose", "Yiqing", "Kevin", "Edward", "Claire", "Lihong", "Linjing", "Jonathan", "Rashed", "Deepansh")

nowies <- is.element(namezlist, c("suresh", "oren", "kasia", "yohai", "noa", "jacky", "azhao", "buxin", "maya", "evan", "isidore", "sabrina", "annarose", "Yiqing", "Kevin", "Edward", "Claire", "Lihong", "Linjing", "Jonathan", "Rashed", "Deepansh"))
oldies <- is.element(namezlist, c("Haoxiang", "amanda", "Anais", "Injy", "Yavuz", "Lilia", "Alexandru", "Youzhi", "Bradley", "Sarah", "Pegah", "Divi", "Romina", "Sizhuo", "Lilie", "jerome", "Louis", "alexparent", "Yagya", "lian", "dinesh", "dhruvanshu"))
