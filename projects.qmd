...
Over the last two years, in work led by Katarzyna Jurewicz, we have obtained a large body of results related to how fixation durations reflect trans-saccadic processing during active vision -- this work has been developed into multiple manuscripts that should be published over the coming year. We continue to collaborate with Katarzyna, who has now moved to a new position in Krakow.

We are also mostly focusing our ongoing efforts in "Neuro-AI" on this topic. We are developing and evaluating models of goal-directed vision that include various modern AI components (including deep convolutional neural networks and transformers). Much of this work is led by Yohai-Eliel Berreby. 

### Hearing and sound

We are working on multiple projects involving visual and auditory localization, motion and objecthood. Our specific auditory interests include envelope processing and sound motion, using behavioral and physiological data analysis and computational modeling.
...
* We have been working on projects to build open-source phone-based eye-trackers. We have also built a version of an infant vision measurement device using eye-tracking. These projects remain work in progress.
